...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_SIDEBAR_DEFAULT_COLLAPSED: process.env.NEXT_PUBLIC_SIDEBAR_DEFAULT_COLLAPSED || 'false',
    
    // 开发配置
    NEXT_PUBLIC_HOT_RELOAD: process.env.NEXT_PUBLIC_HOT_RELOAD || 'true',
    NEXT_PUBLIC_VERBOSE_LOGGING: process.env.NEXT_PUBLIC_VERBOSE_LOGGING || 'false',
